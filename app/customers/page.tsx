      ...
      {isLoading && !hasError && (
        <div className="absolute inset-0 flex items-center justify-center bg-background/80 backdrop-blur-sm z-10">
          <Card className="w-full max-w-md">
            <CardHeader>
              <CardTitle className="text-center">Loading Customer Search</CardTitle>
              <CardDescription className="text-center">
                Connecting to the customer search tool...
              </CardDescription>
            </CardHeader>
        ...
        <div className="absolute inset-0 flex items-center justify-center bg-background z-10">
          <Card className="w-full max-w-md">
            <CardHeader>
              ...
              <CardDescription className="text-center">
                Unable to connect to the customer search tool
              </CardDescription>
            </CardHeader>
            <CardContent className="flex flex-col items-center gap-4">
              <p className="text-sm text-muted-foreground text-center">
                The customer search tool may be unavailable or you may not be connected to the office network.
